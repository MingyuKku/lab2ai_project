  ...
  <transition name="openMyPage">
    <div class="myPage_wrap" v-show="active">
      <div class="myPage_inner">
        <div class="header">
          <div class="myProfile">
            <div class="myProfileIcon"><img :src="`${$static.imgUrl}index/top/followerMentorIcon.svg`" alt="구독멘토아이콘"></div>
...
import MentorAlarmItem from '@/src/components/common/MentorAlarmItem';
export default {
  components: {
    MentorAlarmItem,
  },
  ...
  watch: {
    ...
    // wrapScrollTop(val) { NEED TO CHANGE
    //   this.$ScrollToPlugin.to('.subscribedMentor_wrap', {
    //     duration: 0.3,
    //     scrollTo: val,
    //     ease: "power4.out",
    //   })
...
<style lang='scss'>
  @import '@/src/components/common/css/mentorAlarm.scss';
</style>