        ...
        <div class="desc">
          ...
          <div class="descImg_wrap column">
            <div class="desc_img1 updown">
              <div class="img"><img :src="`${$static.imgUrl}mentorPage/modelDescription/updown_desc1.png`" alt="설명이미지"></div>
