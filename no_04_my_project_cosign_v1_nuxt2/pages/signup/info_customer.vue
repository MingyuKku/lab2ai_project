<template>
  <div class="infoCustomer_wrap">
    ...
    <div class="infoCustomer_body">
      <div class="title">
        <p>&#60;(주)랩투아이&#62;('www.cosign.cc'이하 'COSIGN')는 「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.</p>
        <p>○이 개인정보처리방침은 2022년 3월 28일부터 적용됩니다.</p>
      </div>
      <div class="chapter chapter_1">
        <!-- <h2>[제1장 총칙]</h2> -->
        <div class="article article_1">
          <h3>제1조 (개인정보의 처리 목적)</h3>
          <p>COSIGN은 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며 이용 목적이 변경되는 경우에는 「개인정보 보호법」 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.</p>
          <ul>
            <li>
              홈페이지 회원가입 및 관리
        ...
        <div class="article article_2">
          ...
          <p>COSIGN은 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집 시에 동의 받은 개인정보 보유·이용기간 내에서 개인정보를 처리·보유합니다. 회원탈퇴 등 보유기간 경과 또는 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체 없이 파기합니다.</p>
        </div>
        <div class="article article_3">
          <h3>제3조 (개인정보의 제3자 제공)</h3>
          <p>COSIGN은 개인정보를 제1조(개인정보의 처리 목적)에서 명시한 범위 내에서만 처리하며, 이용자가 사전에 동의한 경우 또는 정보주체의 동의, 법률의 특별한 규정 등 「개인정보 보호법」 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.</p>
        </div>
        ...
        <div class="article article_5">
          ...
          <ul>
            <li>정보주체는 COSIGN에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.</li>
            <li>제1항에 따른 권리 행사는 COSIGN에 대해 「개인정보 보호법」 시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 COSIGN은 이에 대해 지체 없이 조치하겠습니다.</li>
            ...
            <li>COSIGN 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한 대리인인지를 확인합니다.</li>
          </ul>
        </div>
        <div class="article article_6">
          <h3>제6조 (처리하는 개인정보의 항목 작성)</h3>
          <p>COSIGN은 다음의 개인정보 항목을 처리하고 있습니다.</p>
          <span>- 이메일, 비밀번호, 닉네임, 서비스 이용 기록, 접속 로그, 쿠키, 접속 IP 정보</span>
        </div>
        <div class="article article_7">
          <h3>제7조 (개인정보의 파기)</h3>
          <ul>
            <li>COSIGN은 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를 파기합니다.</li>
            ...
            <li>개인정보 파기는 전자적 파일 형태의 정보의 경우 기록을 재생할 수 없는 기술적 방법을 사용합니다. 종이에 출력된 개인정보는 분쇄기로 분쇄하거나 소각을 통하여 파기합니다</li>
          </ul>
        </div>
        <div class="article article_8">
          <h3>제8조 (개인정보의 안전성 확보 조치)</h3>
          <p>COSIGN은 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.</p>
          <ul>
            <li>
              정기적인 자체 감사 실시
        ...
        <div class="article article_9">
          ...
          <ul>
            <li>COSIGN은 이용자에게 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고 수시로 불러오는 ‘쿠키(cookie)’를 사용합니다.</li>
        ...
        <div class="article article_10">
          ...
          <ul>
            <li>COSIGN은 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.
              <p>▶개인정보 보호책임자</p>
              <p>성명 : 오종환</p>
              <p>직책 : 대표</p>
              <p>연락처 : official@lab2ai.com</p>
            </li>
            <li>정보주체께서는 COSIGN의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. COSIGN은 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.</li>
          </ul>
        </div>
        ...
        <div class="article article_12">
          ...
          <p>이 개인정보처리방침은 2022년 3월 28부터 적용됩니다.</p>
        </div>
      </div>
    </div>
  </div>
...
<style lang='scss'>
  @import '@/src/css/signup/infoCustomer.scss';
</style>