  ...
  methods: {
    ...
    async sendChangeAPI() {
      if(!this.validateNicknameChange()) {
        ...
        await axios.post(`${API_URL}/api/user/modify/change`, qs.stringify(changData), {withCredentials: true},
...
<style lang='scss'>
  @import './css/myPagePersonal.scss';
</style>