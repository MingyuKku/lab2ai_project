...
declare global {
    interface Window {
        ...
        MessageHelper: MessageHelperInterface;
        sendUserAgent: (agentInfo:string) => void;
        getAlarms: () => void;
        refetchChatUser: () => Promise<void>;
    }
    ...
    interface FlutterInappwebview {
        callHandler(handleName: string, msg: string): void;
    }

    interface MessageHelperInterface {
        setIsFileAccessGranted: (value: boolean) => void;
    }
