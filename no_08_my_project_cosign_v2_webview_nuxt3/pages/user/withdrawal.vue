<template>
    <div class="user-withdrawal bg-bg-white min-h-viewScreen">
        ...
        <section class="px-primary">
            ...
            <div class="buttons flex items-center mt-6">
                <div @click="messageWebview('close_screen')" class="cancle flex-1 d-button-st h-[50px] bg-bg-black rounded mr-3 text-[16px]">
                    계속 이용하기
                </div>
                <div
        ...
        buttons: {
            ...
            right: {
                ...
                onClick: async () => {
                    ...
                    messageWebview('complete_sign_out');
                }
            }
        }
    })
