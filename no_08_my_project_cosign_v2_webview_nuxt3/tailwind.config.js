    ...
    theme: {
        extend: {
            ...
            backgroundImage: {
                ...
                'cosign-gra2': 'linear-gradient(276deg, #DF2A9D, #F23A61, #F95C36)',
            ...
            height: {
                ...
                'viewScreen-header-nav': 'calc(var(--vh,1vh)*100 - 60px - 60px)',
            ...
            boxShadow: {
                ...
                'inner-01': '0 3px 8px rgba(0,0,0, 0.1), inset 2px 2px 5px rgba(255,243,203,0.5)',
                'dubble-01': '0 13px 10px rgba(0,0,0, 0.07), 0 14px 20px rgba(0,0,0,0.15)',
            },
            dropShadow: {
