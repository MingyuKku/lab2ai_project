<template>
    <div class="no-pattern-ui bg-bg-gray-04">
        <div class="above px-primary pt-space-top-lg pb-space-bottom-lg flex flex-col items-center bg-bg-white">
            ...
            <div
                @click="onClickAlarmSetting"
                class="button w-full h-12 border-[1.5px] border-border-dark-02 rounded-lg flex items-center justify-center mt-space-top-lg"
            >
...
const onClickAlarmSetting = ()  => {
    messageWebview('https://cosign/notification_setting');
}
