<template>
    <div
        class="absolute z-50 bg-bg-white top-full w-full translate-y-1 pt-primary shadow-02 rounded-lg"
    >
        ...
        <div class="grid grid-cols-5 justify-items-center gap-y-4 max-h-[248px] custom-scroll-bar-basic pb-primary px-2">
            <div
