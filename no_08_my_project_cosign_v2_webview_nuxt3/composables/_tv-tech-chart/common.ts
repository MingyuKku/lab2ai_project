...
export const COLOR_CHART_BG = "#F4F6F9", COLOR_LONG = "#00AF85", COLOR_SHORT = "#F3475D", COLOR_GUIDELINE_GRAY = "#BCBEC2", 
    COLOR_BLACK = "#000000", COLOR_WHITE = "#FFFFFF", COLOR_CUTPRICE = "#E9CAB8", COLOR_GRAY = "#D9DCE1",
    ...
    COLOR_DARK_2 = "#707A8A"
    ;
export const PRICE_SCALE_FONT_SIZE = 14, POSITION_LINE_FONT_SIZE = 16, TIME_LABEL = 13;
...
export const getTimeStampByPointTime = (pointTime: string) => {
    return Date.parseUtcToLocal(pointTime).getTime() / 1000;
}
