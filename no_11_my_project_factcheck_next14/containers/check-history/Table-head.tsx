    ...
    return (
        <thead>
            <tr className='h-[50px] bg-achromatic-02 text-achromatic-white'>
                ...
                <th className='px-4 border border-achromatic-03'><div className='flex items-center justify-center'><IconUser /><span className='title-sm ml-2 whitespace-nowrap'>요청자</span></div></th>
