        ...
        <section>
            <div class="title py-2.5 text-center bg-bg-white">
                ...
                <div class="flex-1 pt-[8px] pb-[12px] cursor-pointer" @click="selectedTabMenu = 'subscribe'"
                    :class="(selectedTabMenu === 'subscribe')? 'bg-bg-white text-font-black font-bold border-t-2 border-border-gray-04': 'bg-border-gray-04 text-font-dark-02'">
                    정기 구독권
                </div>
                <div class="flex-1 pt-[8px] pb-[12px] cursor-pointer" @click="selectedTabMenu = '30d'"
                    :class="(selectedTabMenu === '30d')? 'bg-bg-white text-font-black font-bold border-t-2 border-border-gray-04': 'bg-border-gray-04 text-font-dark-02'">
                    30일 이용권
                </div>
                </div>
                ...
                <div class="flex flex-col items-stretch px-[16px] py-[20px] rounded-[8px] border-[1.5px] mx-[16px] my-[16px] relative shadow-[0_4px_8px_0_#ECEEF2]" 
                    ...
                    :class="ticket.isPrimary? 'border-position-short bg-[#FEF4F4]': 'border-border-gray-03'"
                    @click="clickTicket">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="bg-system-mint text-font-white rounded px-[11px] pt-[3px] pb-[5px] text-[12px]">
                    구매하기
                    </div>
                </div>
                </div>
