<template>
    <transition name="opacity" mode="out-in">
        <div
            ...
            class="cosing-alert-popup fixed top-1/2 z-40 bg-bg-white rounded py-primary px-3"
            :class="
                isMobile
                ? 'w-[calc(100%-60px)] -translate-x-1/2 translate-y-[calc(-50%-40px)] max-w-desktop left-1/2'
                : 'w-desktop translate-y-[calc(-50%-40px)]'"
        >
